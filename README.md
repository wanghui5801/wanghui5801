...
Futhermore, I'm working on some of my papers recently, see as follows:



| Title | Description | Journal | Status| Paper|
|-------|-------------|---------|------|------|
| patterncausality: Pattern Causality Algorithm in R | A R package intruduced for pattern causality analysis. | SSRN | Published | <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4966221"><img src="https://img.shields.io/badge/Read_Paper_on_SSRN-4e73df?style=for-the-badge" width="200"></a> |
