...
| The Risk connectedness between International Crude Oil Market and Chinese Asset Markets: From the Perspective of Common and Idiosyncratic Information | A model about the generalized dynamic factor model and pattern causality analysis. | International Review of Financial Analysis | Under<br>Revision |  |
